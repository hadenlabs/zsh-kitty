...
:Version: 0.0.0
:Web: https://github.com/hadenlabs/zsh-kitty
:Download: https://github.com/hadenlabs/zsh-kitty
:Source: https://github.com/hadenlabs/zsh-kitty
:Keywords: zsh-kitty
...
2. Clone the plugin
    ``bash   git clone https://github.com/hadenlabs/zsh-kitty``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-kitty )`` to your list of
    plugins
...
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle hadenlabs/zsh-kitty`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/hadenlabs/zsh-kitty.svg
    :target: https://travis-ci.org/hadenlabs/zsh-kitty
.. |GitHub issues| image:: https://img.shields.io/github/issues/hadenlabs/zsh-kitty.svg
    :target: https://github.com/hadenlabs/zsh-kitty/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/hadenlabs/zsh-kitty/readme
    :target: https://github.com/hadenlabs/zsh-kitty
