<!-- Space: Projects -->
<!-- Parent: ZshKitty -->
<!-- Title: Contributing GithubFlow ZshKitty -->
<!-- Label: ZshKitty -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-kitty project on [GitHub](https://github.com/hadenlabs/zsh-kitty), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-kitty/pulls).
...
To follow the instructions in this guide and start contributing to zsh-kitty project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-kitty.git
```

Now your **upstream** points to **hadenlabs/zsh-kitty**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-kitty
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-kitty/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
